...
Weiter geht es nun mit den für das Spiel und seine Datenaufzeichnung wichtigen Funktionen und dem "Gefäß" in dem wir die Daten abspeichern.
...
- Kurz und knapp: Die Funktio nimmt als Input 'last_action' (was wie wir später sehen einem dieser drei Vektoren entspricht), gleicht diesen Input mit den 3 angegebenen ab und ändert den Wert der Variable 'last_action_trnsl' vpn "NA" zu dem entsprechenden String, und gibt die Variable mit dem neuen Wert zurück.
...
- Wir sagen hier, wie viele Episoden gespielt werden, bis das Spiel geschlossen wird. Eine Episode entspricht einem Spieldurchlauf, der Spieldurchlauf wird wiederum beendet, indem ein festgelegtes Ziel erreicht wird. Bspw. endet im Szenario "Basic" eine Episode, sobald das Monster getötet (erschossen) wurde. Im Beispiel ist sie auf 3 festgesetzt, was meiner Meinung nach ein guter Wert für Tests ist. Man möchte keine 10 oder mehr Durchläufe spielen müssen um z.B. zu sehen, ob die geänderte Datenaufzeichnung für mehrere Episoden richtig funktioniert
